...
export class ColorPickerElement extends LitElement {
  ...
  static override properties = {
    ...
    svSat: { state: true },
    svVal: { state: true },
    alphaPercent: { state: true },
    hexInput: { state: true },
    hexInputEditing: { state: true },
  };
   ...
   */
  declare palette: string | undefined;
  ...
  declare hue: number;
  declare svSat: number; // HSV saturation 0–100
  declare svVal: number; // HSV value 0–100
  declare alphaPercent: number;

  declare hexInput: string;
  declare hexInputEditing: boolean;

  private pickerDragging = false;
  private hueDragging = false;
  private hueDragStartX = 0;
  private hueDragStartHue = 0;
  ...
  private calcHueDelta(clientX: number): number {
  ...
  private alphaDragStartX = 0;
  private alphaDragStartPct = 0;
  ...
  private calcAlphaDelta(clientX: number): number {
